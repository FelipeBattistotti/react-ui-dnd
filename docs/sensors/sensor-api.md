...
- Create extraordinary scripted **experiences**
...
> ✍️ [Raathi Kugarajan](https://twitter.com/Raathigesh) has written a blog : ["Scripted natural motion with react-ui-dnd"](https://dev.to/raathigesh/scripted-natural-motion-with-react-ui-dnd-4ifj) which outlines how you can create scripted user behaviour with the Sensor API 👏
