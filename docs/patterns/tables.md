...
| Can reorder items in the table!                  | `react-ui-dnd` 😎 |

`react-ui-dnd` requires no additional wrapping elements to create `<Draggable />` and `<Droppable />` components. Therefore it is possible to have a `<table>` that has valid HTML as well as supporting drag and drop.
...
[See example code here](https://react-ui-dnd.netlify.app/?selectedKind=Tables&selectedStory=with%20fixed%20width%20columns&full=0&addons=1&stories=1&panelRight=0&addonPanel=storybook%2Factions%2Factions-panel)
...
[See example code here](https://react-ui-dnd.netlify.app/?selectedKind=Tables&selectedStory=with%20dimension%20locking&full=0&addons=1&stories=1&panelRight=0&addonPanel=storybook%2Factions%2Factions-panel)
...
- [With our cloning API](https://react-ui-dnd.netlify.app/?path=/story/tables--with-clone)
- [With your own portal](https://react-ui-dnd.netlify.app/?path=/story/tables--with-portal)
